...
ADMIN_WHATSAPP_NUMBER="085179963877"
...
echo -e "\033[32mWHATSAPP VINZZ OFFC : 085179963877\033[0m"
echo -e "\033[31mTELEGRAM : t.me/vinzzofficial\033[0m"
echo -e "${RED} © Vinzz Official"
echo ""
...
case "$OPTION" in
    1)
        ...
        GITHUB_TOKEN="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"

        # Clone repositori menggunakan token
        REPO_URL="https://github.com/VinzzXD24/installer-premium.git"
...
;;
     7)
# Default URL gambar
DEFAULT_URL="https://raw.githubusercontent.com/VinzzXD24/installer-premium/refs/heads/main/vinzz.jpg"
...
sudo mkdir -p /etc/apt/keyrings
curl -fsSL https://deb.nodesource.com/gpgkey/nodesource-repo.gpg.key | sudo gpg --dearmor -o /etc/apt/keyrings/nodesource.gpg
echo "deb [signed-by=/etc/apt/keyrings/nodesource.gpg] https://deb.nodesource.com/node_20.x nodistro main" | tee /etc/apt/sources.list.d/n
